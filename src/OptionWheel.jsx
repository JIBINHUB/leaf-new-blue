/**
 * OptionWheel — a curved, draggable option picker.
 *
 * Component supplied by the project owner and kept as provided apart from this
 * header. Its stylesheet is authored locally in OptionWheel.css, which the
 * supplied snippet does not include.
 *
 * Note on use: this is a picker. It fades and blurs everything except the
 * selected option, so it should always be paired with somewhere the selected
 * item is shown in full — never used to present content on its own.
 */
