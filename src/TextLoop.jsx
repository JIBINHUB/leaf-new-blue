/**
 * TextLoop — text flowing along a curved path with a ribbon behind it.
 *
 * Component supplied by the project owner (React Bits, MIT). Kept as provided
 * apart from this header; its accompanying stylesheet is authored locally in
 * TextLoop.css, which the upstream snippet does not include.
 */
